    ...
    "paths": {
        ...
        "/code": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CreateCodeRequest",
                        "name": "store",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateCode"
                        }
                    }
                ],
                "responses": {
        ...
        "/code/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdateCodeRequest",
                        "name": "store",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateCode"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "DeleteCodeRequest",
                        "name": "store",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CodePrimaryKey"
                        }
                    }
                ],
                "responses": {
